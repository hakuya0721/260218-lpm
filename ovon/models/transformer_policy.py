...
class OVONTransformerPolicy(PointNavResNetCLIPPolicy):
        ...
        **kwargs,
        ...
        NetPolicy.__init__(
            ...
            OVONTransformerNet(
                ...
                segm_update_config=segm_update_config,
    ...
    def from_config(cls, config: DictConfig, *args, **kwargs):
        ...
        segm_update_config = config.habitat_baselines.rl.policy.segm_update_config
        return super().from_config(config, transformer_config=tf_cfg, segm_update_config=segm_update_config, *args, **kwargs)
...
class OVONTransformerNet(OVONNet):
    ...
    def __init__(self, transformer_config, segm_update_config, *args, **kwargs):
        self.transformer_config = transformer_config
        self.segm_update_config = segm_update_config
    ...
    def forward(
        ...
        #print("rnn_build_seq_info", rnn_build_seq_info["step_id"])
        feats, rnn_hidden_states, aux_loss_state = super().forward(
            observations,
            rnn_hidden_states,
            prev_actions,
            prev_segm_masks,
        ...
        return feats, rnn_hidden_states, aux_loss_state
