...
class NetPolicy(nn.Module, Policy):
    ...
    def act(
        ...
        return value, action, action_log_probs, rnn_hidden_states, aux_loss_state['prev_segm_masks']

    def get_value(self, observations, rnn_hidden_states, prev_actions, prev_segm_masks, masks):
